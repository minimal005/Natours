...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoibWluaW1hbDAwNSIsImEiOiJjbHY4Ymp2d24wYnFzMmtsa3l5ZzV4cmFoIn0.7BfUm9VxOmDPoYazEoL-XQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/minimal005/clv8fikmf008501qzgat6dkb9',
    // style URL
    zoom: 9,
    // starting zoom
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Успішний вхід!');
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Помилка виходу! Спробуйте знову.');
        case 11:
        case "end":
...
// DELEGATION
if (mapBox) {
  // отримуємо доступ до data-атрибуту з HTML
