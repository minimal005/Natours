...
exports.logout = (req, res) => {
  // при виході з системи ми в файл куки відправляємо ту саму назву jwt, але вміст замінюємо довільним текстом.
  // тепер замість токену буде довільний текст і користувач престане бути авторизованим по токену і війде з системи
  res.cookie('jwt', 'loggedout', {
    // expires термін придатності кукі після виходу з системи
